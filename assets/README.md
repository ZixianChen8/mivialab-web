...
Project-wide files that are not part of the production app bundle.

- `docs/` — strategy, copy, and reference documents
  - `mivialab-business.md` — positioning & messaging
  - `mivialab-site-structure.md` — v1 website IA
