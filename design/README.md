...
**Start here:** open [`index.html`](index.html) to compare all three homepage directions.

| Folder | Mood |
|--------|------|
| [`editorial/`](editorial/) | Editorial minimal — typography-led, premium studio |
| [`fashion-editorial/`](fashion-editorial/) | Fashion editorial — monochrome + hero color reveal, magazine layout |
...
When a direction is chosen, implement it in `web/`.
